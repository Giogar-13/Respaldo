...
fetch("../dynamics/php/consultaEstado.php")
    .then((response) => {
        return retsp = response.text();
    }).then((text) => {
        let estado = parseInt(text, 10);
        if (estado === 2) {
            alert("Usted no puede hacer encuestas");
            window.location = "../templates/principalEncuestas.html";
        }
    })
...
boton1.addEventListener("click", () => {
    ...
    if (input != "") {
        ...
        alert("Ingresaste una opción vacía. Intenta nuevamente.");
    }
...
agregar.addEventListener("click", () => {
    ...
    if (pregunta != "") {
        ...
        alert("Ingresaste una pregunta vacía. Intenta nuevamente.");
    }
...
enc.addEventListener("click", () => {
    ...
    if (descripcionFinal != "" && tituloEncuesta != "") {
        ...
        console.log(opcionesAMandar);
        console.log(preguntasAMandar);
        console.log(invitadosAMandar);
        console.log(categoriaAMandar);
        ...
        alert("Ingresa correctamente la información de tu encuesta ")
    }
